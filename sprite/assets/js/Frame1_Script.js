...
function showText(x, y, z, msg, font) {
    ...
    scene.add(myFunction(0, 1.5, 0, 'Syed Rehan Hussain Rizvi (B21110004007)',font));
    scene.add(myFunction(0, 0.5, 0, 'Muhammad Farooq (B21110004003)',font));
    scene.add(myFunction(0, 0, 0, 'Abdullah Bin Abdul Qadeer (B21110004001)',font));
    scene.add(myFunction(0, 1, 0, 'Syed Muhammad Qasim Ali (B19102142)',font));
    //myFunction(msg)
