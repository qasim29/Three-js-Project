...
// dragon spritesheet
const dragon_map = new THREE.TextureLoader().load( 'assets/textures/dragon3.png' );
...
if(window.location.pathname.includes("frame1")){
    ...
    scene.add(showText(0, 1.5, 0, 'Syed Rehan Hussain Rizvi (B21110004007)',font));
    scene.add(showText(0, 0.5, 0, 'Muhammad Farooq (B21110004003)',font));
    scene.add(showText(0, 0, 0, 'Abdullah Bin Abdul Qadeer (B21110004001)',font));
    scene.add(showText(0, 1, 0, 'Syed Muhammad Qasim Ali (B19102142)',font));
    scene.add(showText(0.7, -3.8, -3, 'Press W to run sprite animation',font))
}); 
}
